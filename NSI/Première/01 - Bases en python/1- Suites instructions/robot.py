...
def haut() :
    ...
    pos[1] -= 1
    if buisson() : print("Vous avez pouss̩ le robot dans un buisson")  
    if piege() : print("Vous avez pouss̩ le robot dans un piege")  
    if cle() : print("Bravo !")
...
def deplacer(a,b) :
    ...
    if not check(b-1): 
        print('vous avez cr̩̩ un empilement instable sur la pile ',b)
        OK = False
